...
#[derive(Debug)]
pub struct WasabiKickProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WasabiKickProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WasabiKick processing");
    
    let mut processor = WasabiKickProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WasabiKickProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WasabiKickProcessor::new(false);
